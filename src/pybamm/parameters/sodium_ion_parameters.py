#
# Standard parameters for sodium-ion battery models
#
import pybamm
from .base_parameters import BaseParameters, NullParameters


class SodiumIonParameters(BaseParameters):
    """
    ...
    def _set_parameters(self):
        ...
        self.ocp_soc_0_dimensional = self.elec.ocp_soc_0
        self.ocp_soc_100_dimensional = self.elec.ocp_soc_100
    ...
    def chi(self, c_e, T):
        ...
        """
        return ((1 - 2 * self.t_plus(c_e, T))) * (self.thermodynamic_factor(c_e, T))
...
class ParticleLithiumIonParameters(BaseParameters):
    ...
    def _set_parameters(self):
        ...
        self.alpha_bv = pybamm.Parameter(
            f"{pref}{Domain} electrode charge transfer coefficient"
        )
