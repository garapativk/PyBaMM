...
class SPMe(SPM):
    """
    Single Particle Model with Electrolyte (SPMe) of a sodium-ion battery, from
    :footcite:t:`Chayambuka2022, Garapati2024`. Inherits most submodels from SPM, only modifies
    potentials and electrolyte. See :class:`pybamm.lithium_ion.BaseModel` for more
    details.

    Examples
    --------
    >>> model = pybamm.sodium_ion.SPMe()
    >>> model.name
