...
def NVPF_diffusivity_Chayambuka2022(sto, T):
    ...
    # fitting ignoring the data points near to soc ~ 100 
...
def _kp(c_s_surf, T):
    """
    kinetic rate constant of positive electrode for Intercalation reaction of Na.
    To be used in computing the Excahnge current density for Butler-Volmer reactions
...
parameter_values =  pybamm.ParameterValues({
    ...
    "Contact resistance of negative electrode [Ohm]": 2e-3/2.54e-4,
    "Contact resistance of positive electrode [Ohm]": 8.5e-3/2.54e-4,
    ...
    # thermal parameters(being set arbitrarily for now)
    "Total heat transfer coefficient [W.m-2.K-1]": 1,
    "Cell cooling surface area [m2]": 2.54e-4,
